...
protected:
    void SetUp() override {
        testVectorsPath = "/Volumes/Code/source/repos/brightchain-cpp/tests/test_vectors_ecies.json";
    }
...
TEST_F(EciesCrossCompatTest, EncryptForTypeScript) {
    ...
    std::string outputPath = "/Volumes/Code/source/repos/brightchain-cpp/tests/test_vectors_cpp_ecies.json";

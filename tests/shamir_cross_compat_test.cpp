...
protected:
    void SetUp() override {
        testVectorsPath = "/Volumes/Code/source/repos/brightchain-cpp/tests/test_vectors_shamir.json";
    }
...
TEST_F(ShamirCrossCompatTest, GenerateSharesForTypeScript) {
    ...
    std::string outputPath = "/Volumes/Code/source/repos/brightchain-cpp/tests/test_vectors_cpp_shamir.json";
